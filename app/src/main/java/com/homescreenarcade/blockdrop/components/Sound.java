...
//		c.setVolumeControlStream(AudioManager.STREAM_RING);
		...
		soundPool = new SoundPool(c.getResources().getInteger(R.integer.audio_streams),AudioManager.STREAM_RING,0);
	...
	public void loadMusic(int type, int startTime) {
		...
		musicPlayer.setAudioStreamType(AudioManager.STREAM_RING);
