...
public class Controls extends Component {
	...
	public void leftButtonPressed(boolean onceOnly) {
		host.game.action();
		clearLeftMove = onceOnly;
		leftMove = true;
		rightMove = false;
	...
	public void rightButtonPressed(boolean onceOnly) {
		host.game.action();
		clearRightMove = onceOnly;
		rightMove = true;
		leftMove = false;
		host.game.setNextPlayerMoveTime(host.game.getTime());
		host.sound.buttonSound();
	...
	public void cycle(long tempTime) {
		...
		// Left Move
		if(leftMove) {
			continuousLeftMove = !clearLeftMove;
			leftMove = false;
		...
		// Right Move
		if(rightMove) {
			continuousRightMove = !clearRightMove;
			rightMove = false;
	 ...
	 */
	@Override
	public void reconnect(BlockDropWallpaper cont) {
